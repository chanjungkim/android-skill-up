...
import com.example.android.sunshine.ui.list.ForecastAdapter.ForecastAdapterOnItemClickHandler
...
class MainActivity : AppCompatActivity(), ForecastAdapterOnItemClickHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel!!.forecast.observe(this, { weatherEntries: List<ListWeatherEntry> ->
            ...
            // and is loaded
            if (weatherEntries != null && weatherEntries.size != 0) showWeatherDataView() else showLoading()
        })
    }
