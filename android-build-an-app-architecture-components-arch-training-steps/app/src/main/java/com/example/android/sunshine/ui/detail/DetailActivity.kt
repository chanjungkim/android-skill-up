...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel!!.weather.observe(this, { weatherEntry: WeatherEntry? ->
    ...
    private fun bindWeatherToUI(weatherEntry: WeatherEntry) {
        ...
        /* Set the resource ID on the icon to display the art */mDetailBinding!!.primaryInfo.weatherIcon.setImageResource(weatherImageId)
        /****************
         * Weather Date *
         */
        /*
         ...
         */
        /* Read wind speed (in MPH) and direction (in compass degrees)*/  val windSpeed = weatherEntry.wind
